...
public:
	...
	virtual TilePoint XYToTilePoint(const Point& point) const;
	virtual Point ToXYPoint(const TilePoint& point) const;
	Point ToXYPoint3D(const TilePoint3D& point) const;
