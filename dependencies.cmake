...
function(InstallZlib)
    ...
    set(ZLIB_BUILD_SHARED $<IF:$<BOOL:${LANDSTALKER_BUILD_SHARED}>,ON,OFF> CACHE BOOL "" FORCE)
    set(ZLIB_BUILD_STATIC $<IF:$<BOOL:${LANDSTALKER_BUILD_SHARED}>,OFF,ON> CACHE BOOL "" FORCE)
...
function(InstallLibpng)
    ...
    set(PNG_STATIC $<IF:$<BOOL:${LANDSTALKER_BUILD_SHARED}>,OFF,ON> CACHE BOOL "" FORCE)
...
function(InstallYamlcpp)
    ...
    set(YAML_BUILD_SHARED_LIBS $<IF:$<BOOL:${LANDSTALKER_BUILD_SHARED}>,ON,OFF> CACHE BOOL "" FORCE)
